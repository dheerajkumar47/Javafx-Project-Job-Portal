...
public class Main extends Application {
	...
	public void start(Stage sta) throws Exception {
		...
		Image image = new Image("file:///C:/Users/HP/eclipse-workspace/job%20portal/welcome.jpg");
	...
	void applicantComponents() {
		...
		cmbcountry.getItems().addAll("Pakistan");
		...
		jp.add(breg, 1,9);
		Image image = new Image("file:///C:/Users/HP/eclipse-workspace/job%20portal/hi.jpg");
